                ...
                <div class="childrenBody">
                    <blockquote class="layui-elem-quote news_search">
                        ...
                        <div class="layui-inline" style="margin-left:60px;">
                            <form action="${pageContext.request.contextPath}/toSellerOrdersList" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="layui-btn-group">
                                            <button class="ordersView layui-btn layui-btn-xs" orderId="${order.id}" sellerId="${sellerId}" lay-event="edit">   <!-- 查看该订单 -->
...
<script type="text/javascript" src="${pageContext.request.contextPath }/static/localjs/sellerOrdersList.js"></script>
