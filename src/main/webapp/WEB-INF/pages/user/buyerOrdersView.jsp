                ...
                <div class="childrenBody">
                    <blockquote class="layui-elem-quote news_search">
                        <div class="layui-inline">
                            <a class="backBuyerOrdersList layui-btn layui-btn-normal newsAdd_btn" buyerId="${buyerId}"><i class="layui-icon"></i> 返回${buyerId}</a>
                        </div>
                        <div class="layui-inline" style="margin-left:60px;">
                            <form action="${pageContext.request.contextPath}/toBuyerOrdersView" method="post">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/static/localjs/buyerOrdersView.js"></script>
